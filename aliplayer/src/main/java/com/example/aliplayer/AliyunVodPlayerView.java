...
import com.example.aliplayer.control.ControlView;
import com.example.aliplayer.gesture.GestureDialogManager;
import com.example.aliplayer.gesture.GestureView;
import com.example.aliplayer.theme.ITheme;
import com.example.aliplayer.thumbnail.ThumbnailView;
import com.example.aliplayer.tipsview.LoadingView;
import com.example.aliplayer.tipsview.TipsView;
...
//        }
    ...
    private void initTipsView() {
        ...
        mTipsView.setOnTipClickListener(new TipsView.OnTipClickListener() {
            ...
            public void onStopPlay() {
                VcPlayerLog.d(TAG, "onStopPlay = " + mPlayerState);
                // 结束播放
                mTipsView.hideAll();
                stop();
            ...
            public void onRetryPlay() {
                VcPlayerLog.d(TAG, "onRetryPlay = " + mPlayerState);
                //重试
                reTry();
            }
            ...
            public void onReplay() {
                VcPlayerLog.d(TAG, "onReplay = " + mPlayerState);
                //重播
                rePlay();
            }
    ...
    private LoadingView mCoverView;

    /**
     * 初始化封面
     */
    private void initCoverView() {
        mCoverView = new LoadingView(getContext());
        //这个是为了给自动化测试用的id
        addSubViewByCenter(mCoverView);
    }
