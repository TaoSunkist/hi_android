...
public class ErrorView extends RelativeLayout implements ITheme {
    ...
    private void init() {
        ...
        View view = inflater.inflate(R.layout.view_alivc_error, null);
    ...
    public void updateTips(int errorCode, String errorEvent, String errMsg) {
        ...
        mCodeView.setText("errorCode - " + errorEvent);
    }
    ...
    public void setTheme(AliyunVodPlayerView.Theme theme) {
        mRetryView.setBackgroundResource(R.drawable.alivc_rr_bg);
        mRetryBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_rotating_arrow_left_white, 0, 0, 0);
    mRetryBtn.setTextColor(Color.WHITE);
    }
