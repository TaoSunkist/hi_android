...
public class MutiSeekBarView extends AppCompatSeekBar {
     ...
     * 原视频进度条颜色,默认白色
     */
    private int mSourceSeekColor = getResources().getColor(android.R.color.white);

    /**
     * 视频进度条颜色,默认蓝色
     */
    private int mAdvSeekColor = Color.parseColor("#B35BFF");
    ...
    public MutiSeekBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MutiSeekBarView(Context context, AttributeSet attrs, int defStyleAttr) {
