package top.thsunkist.tatame.utilities.permissions;
...
public class RxPermissions {
  ...
  /**
   * Request permissions immediately, <b>must be invoked during initialization phase of your
   * application</b>.
   */
  ...
  /**
   * Invokes Activity.shouldShowRequestPermissionRationale and wraps the returned value in an
   * observable.
   *
   * <p>In case of multiple permissions, only emits true if
   * Activity.shouldShowRequestPermissionRationale returned true for all revoked permissions.
   *
   * <p>You shouldn't call this method if all permissions have been granted.
   *
   * <p>For SDK &lt; 23, the observable will always emit false.
   */
  @SuppressWarnings("WeakerAccess")
  ...
  void requestPermissionsFromFragment(String[] permissions) {
    mRxPermissionsFragment.log(
        "requestPermissionsFromFragment " + TextUtils.join(", ", permissions));
  ...
  void onRequestPermissionsResult(String permissions[], int[] grantResults) {
    mRxPermissionsFragment.onRequestPermissionsResult(
        permissions, grantResults, new boolean[permissions.length]);
  }
}
