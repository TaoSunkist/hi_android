...
class Debug {
    companion object {
        ...
        val voices = listOf("https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3")

        val videos = listOf("https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3")


        fun randomColor(): Int = Color.rgb((30..200).random(), (30..200).random(), (30..200).random())
    }
}
