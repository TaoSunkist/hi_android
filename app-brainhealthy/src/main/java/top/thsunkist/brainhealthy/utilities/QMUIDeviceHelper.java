...
import top.thsunkist.brainhealthy.utilities.StringUtilityKt;
...
import static top.thsunkist.brainhealthy.utilities.DebugToolsKt.printf;
    ...
    static {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            ...
            try {
                ...
                printf(TAG, e, "read file error");
            } finally {
                StringUtilityKt.close(fileInputStream);
            }
        }
        ...
        try {
            ...
            printf(TAG, e, "read SystemProperties error");
        }
    }
