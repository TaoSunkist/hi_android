...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (!mIsThumbUseDrawable && mThumbColor == null) {
            mThumbColor = ColorUtility.INSTANCE.generateThumbColorWithTintColor(mTintColor);
        ...
        if (!mIsBackUseDrawable && mBackColor == null) {
            mBackColor = ColorUtility.INSTANCE.generateBackColorWithTintColor(mTintColor);
