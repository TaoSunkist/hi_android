...
public class SquareProgressBar extends RelativeLayout {
    ...
    /**
     * Sets the image of the {@link SquareProgressBar}. Must be a valid ressourceId.
     *
     * @param image
    ...
    /**
     * Sets the image of the {@link SquareProgressBar}. Must be a valid Drawable.
     *
     * @param imageDrawable
     *         the image as a Drawable
     * @author erikswed
     * @since 1.6.1
     */
    ...
    /**
     * Sets the progress of the {@link SquareProgressBar}. If opacity is selected then here it sets
     * it. See {@link #setOpacity(boolean)} for more information.
     *
     * @param progress
     *         the progress
     * @since 1.0.0
    ...
    /**
     * Sets the colour of the {@link SquareProgressBar} to a predefined android holo color.
     * <b>Examples:</b>
     * <ul>
    ...
    /**
     * Sets the colour of the {@link SquareProgressBar}. YOu can give it a hex-color string like
     * <i>#C9C9C9</i>.
     *
     * @param colorString
    ...
    /**
     * This sets the colour of the {@link SquareProgressBar} with a RGB colour. Works when used
     * with
    ...
    /**
     * This sets the alpha of the image in the view. Actually I need to use the deprecated method
     * here as the new one is only available for the API-level 16. And the min API level of this
     * library is 14.
     * <p>
    ...
    /**
     * Switches the opacity state of the image. This forces the SquareProgressBar to redraw with the
     * current progress. As bigger the progress is, then more of the image comes to view. If the
     * progress is 0, then you can't see the image at all. If the progress is 100, the image is
     * shown full.
     *
     * @param opacity
     ...
     * shown full.
     * <p>
     * You can also set the flag if the fading should get inverted so the image disappears when the
     * progress increases.
     *
     * @param opacity
     *         true if opacity should be enabled.
     * @param isFadingOnProgress
     *         default false. This changes the behavior the opacity works. If the progress increases
     *         then the images fades. When the progress reaches 100, then the image disappears.
     * @since 1.4.0
     */
    ...
    /**
     * Draws the startline. this is the line where the progressbar starts the drawing around the
     * image.
     *
     * @param drawStartline
     *         true if it should or not.
    ...
    /**
     * Sets a custom percent style to the text inside the image. Make sure you set {@link
     * #showProgress(boolean)} to true. Otherwise it doesn't shows. The default settings are: Text
     * align: CENTER Text size: 150 [dp] Display percentsign: true Custom text: %
     *
     * @param percentStyle
     *         the percent style
     */
    ...
    /**
     * Returns the {@link PercentStyle} of the percent text. Maybe returns the default value, check
     * {@link #setPercentStyle(PercentStyle)} fo that.
     *
    ...
    /**
     * If the progress hits 100% then the progressbar disappears if this flag is set to
     * <code>true</code>. The default is set to false.
     *
     ...
     *
     * @param bitmap
     *         the {@link android.graphics.Bitmap} to set.
     */
    ...
    /**
     * Set the status of the indeterminate mode. The default is false. You can still configure
     * colour, width and so on.
     *
     * @param indeterminate
     *         true to enable the indeterminate mode (default true)
     * @since 1.6.0
     */
