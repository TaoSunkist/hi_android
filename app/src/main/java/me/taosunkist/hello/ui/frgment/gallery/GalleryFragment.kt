package me.taosunkist.hello.ui.frgment.gallery
...
import me.taosunkist.hello.utility.picturechooser.PictureCfg
import me.taosunkist.hello.utility.picturechooser.PictureChooser
		...
		rxPermissions.request(Manifest.permission.READ_EXTERNAL_STORAGE)
			.subscribe(object : Observer<Boolean> {
				...
				override fun onNext(aBoolean: Boolean) {
					if (aBoolean) readLocalMedia() else readLocalMedia()
				}
