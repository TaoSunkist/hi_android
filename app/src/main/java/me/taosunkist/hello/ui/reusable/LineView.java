...
/**
 * Created by lsp on 2018/3/15 09 24 Email:6161391073@qq.com
 */
...
public class LineView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        switch (heightMode) {
            case MeasureSpec.AT_MOST:
                lineHeight = dp2px(getContext(), 350);
                break;
    ...
    protected void onDraw(Canvas canvas) {
        showLineAreaWidth = lineWidth - leftTxtWidth - leftDes;
        showLineAreaHeight = lineHeight - bootomDes - bottomTxtHeight;
    ...
    private void drawLeftText(Canvas canvas) {
        ...
        canvas.translate((lineWidth - showLineAreaWidth) / 2, showLineAreaHeight);
    ...
    private void drawRectLineAndBg(Canvas canvas) {
        canvas.drawLine(lineWidth - showLineAreaWidth, 0, lineWidth - showLineAreaWidth, showLineAreaHeight, linePaint);
        canvas.drawLine(lineWidth - showLineAreaWidth, showLineAreaHeight, lineWidth, showLineAreaHeight, linePaint);
        canvas.drawRect(lineWidth - showLineAreaWidth, 0, lineWidth, showLineAreaHeight, bgPaint);
    }
    ...
    private void drawBottomText(Canvas canvas) {
        ...
        canvas.save();
        canvas.translate(lineWidth - showLineAreaWidth, showLineAreaHeight + ((bootomDes + bottomTxtHeight) / 2) + bottomTxtHeight / 2);
    ...
    public Float getXPix(int i) {
        return lineWidth - showLineAreaWidth + xGap * (i + 1);
    }
