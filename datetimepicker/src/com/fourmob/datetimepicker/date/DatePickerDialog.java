...
public class DatePickerDialog extends DialogFragment implements View.OnClickListener, DatePickerController {
	 ...
	 * 范围最大年份
	 */
	private static final int MAX_YEAR = CURRENT_YEAR - 10;
	/**
	 * 范围最小年份
	 */
	private static final int MIN_YEAR = CURRENT_YEAR - 80;
    ...
    public static DatePickerDialog newInstance(OnDateSetListener onDateSetListener, int month, int day) {
    	return newInstance(onDateSetListener, MIN_YEAR, month, day, true);
	}
